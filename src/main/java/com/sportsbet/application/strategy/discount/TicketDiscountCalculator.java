...
/**
 * The TicketDiscountCalculator interface represents a strategy for calculating the discount rate base on ticket
 * information.
 */
public interface TicketDiscountCalculator {
     ...
     * @return The discount rate as a decimal value between 0 and 1. For example, a discount rate of 0.1 represents 10%
     * off.
     */
