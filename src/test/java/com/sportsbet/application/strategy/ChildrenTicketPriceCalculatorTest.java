...
public class ChildrenTicketPriceCalculatorTest extends BaseTest {

    @InjectMocks
    private ChildrenTicketPriceCalculator ticketPriceCalculator;
    ...
    void shouldGetAdultTicket() {
        ...
        //should
        double expectedActualTotalCost = 5.00 * quantity;
