...
public class TransactionControllerIntegrationTest {
    ...
    public void testGetTicketsValidRequestShouldReturn200(TransactionRequest transactionRequest, TransactionResponse expectedTransactionResponse) throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(
                ...
                .andReturn();
        TransactionResponse actualTransactionResponse = objectMapper.readValue(mvcResult.getResponse().getContentAsString(), TransactionResponse.class);
    ...
    public void testGetTicketsValidRequestShouldReturn400(TransactionRequest transactionRequest, ErrorResponse expectedErrorResponse) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        ...
        MvcResult mvcResult = mockMvc.perform(
                ...
                .andReturn();
        ErrorResponse actualErrorResponse = objectMapper.readValue(mvcResult.getResponse().getContentAsString(), ErrorResponse.class);
